...
var bounce1, black1, black2, white1, white2, backImg, whiteStar, blackStar, white, obstImg, obst2Img;
...
function setup(){
    ...
    testPlayer2 = new Player2(width/1.3, height/8, width/28, width/28)
